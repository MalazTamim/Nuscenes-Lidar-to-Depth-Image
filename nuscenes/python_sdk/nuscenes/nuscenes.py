...
class NuScenes:
    ...
    def render_lidar_pointcloud_in_image(self, sample_token: str, dot_size: int = 5, pointsensor_channel: str = 'LIDAR_TOP',
                                   camera_channel: str = 'CAM_FRONT', out_path: str = None,
                                   render_intensity: bool = False,
                                   show_lidarseg: bool = False,
                                   filter_lidarseg_labels: List = None,
                                   ...
                                   lidarseg_preds_bin_path: str = None,
                                   show_panoptic: bool = False) -> None:
        self.explorer.render_lidar_pointcloud_in_image(sample_token, dot_size, pointsensor_channel=pointsensor_channel,
                                                 camera_channel=camera_channel, out_path=out_path,
                                                 render_intensity=render_intensity,
                                                 show_lidarseg=show_lidarseg,
                                                 filter_lidarseg_labels=filter_lidarseg_labels,
    ...
    def render_radar_pointcloud_in_image(self,
                                   sample_token: str,
                                   dot_size: int = 5,
                                   pointsensor_channel: str = 'LIDAR_TOP',
                                   camera_channel: str = 'CAM_FRONT',
                                   out_path: str = None,
                                   lidar_depth_path: str=None,
                                   render_intensity: bool = False,
                                   show_lidarseg: bool = False,
                                   filter_lidarseg_labels: List = None,
                                   ax: Axes = None,
                                   ...
                                   lidarseg_preds_bin_path: str = None,
                                   show_panoptic: bool = False) -> None:
        self.explorer.render_radar_pointcloud_in_image(sample_token, dot_size, pointsensor_channel=pointsensor_channel,
                                                 camera_channel=camera_channel, out_path=out_path,
                                                 lidar_depth_path=lidar_depth_path,
                                                 render_intensity=render_intensity,
                                                 show_lidarseg=show_lidarseg,
                                                 filter_lidarseg_labels=filter_lidarseg_labels,
                                                 show_lidarseg_legend=show_lidarseg_legend,
    ...
    def render_pointcloud_in_image_black_grayscale(self, sample_token: str, dot_size: int = 5, pointsensor_channel: str = 'LIDAR_TOP',
                                   camera_channel: str = 'CAM_FRONT', out_path: str = None,
                                   render_intensity: bool = False,
                                   show_lidarseg: bool = False,
                                   filter_lidarseg_labels: List = None,
                                   ...
                                   lidarseg_preds_bin_path: str = None,
                                   show_panoptic: bool = False) -> None:
        self.explorer.render_pointcloud_in_image_black_grayscale(sample_token, dot_size, pointsensor_channel=pointsensor_channel,
                                                 camera_channel=camera_channel, out_path=out_path,
                                                 render_intensity=render_intensity,
                                                 show_lidarseg=show_lidarseg,
                                                 filter_lidarseg_labels=filter_lidarseg_labels,
    ...
    def render_pointcloud_in_sweep(self, image_path: str, dot_size: int = 5, pointsensor_channel: str = 'LIDAR_TOP',
                                   camera_channel: str = 'CAM_FRONT', out_path: str = None,
                                   render_intensity: bool = False,
                                   show_lidarseg: bool = False,
                                   filter_lidarseg_labels: List = None,
        ...
        self.explorer.render_pointcloud_in_image(sample_token=sample_token, dot_size=dot_size, pointsensor_channel=pointsensor_channel,
                                        camera_channel=camera_channel, out_path=out_path,
                                        render_intensity=render_intensity,
                                        show_lidarseg=show_lidarseg,
                                        filter_lidarseg_labels=filter_lidarseg_labels,
...
class NuScenesExplorer:
    ...
    def render_lidar_pointcloud_in_image(self,
                                   sample_token: str,
                                   dot_size: int = 5,
                                   pointsensor_channel: str = 'LIDAR_TOP',
                                   camera_channel: str = 'CAM_FRONT',
        ...
        black_im = Image.new('RGB', im.size, (0, 0, 0))
        ax.imshow(black_im)
        ax.scatter(points[0, :], points[1, :], c=coloring, s=dot_size)
        ax.axis('off')
    ...
    def render_radar_pointcloud_in_image(self,
        ...
        radar_token = sample_record['data'][pointsensor_channel]
        
        radar_points,coloring, im = self.map_pointcloud_to_image(
        ...
        ax.imshow(black_im)
        ax.scatter(radar_points[0, :], radar_points[1, :], c=coloring, s=dot_size)
        ax.axis('off')
    ...
    def render_pointcloud_in_image_black_grayscale(self,
                                   sample_token: str,
                                   dot_size: int = 5,
                                   pointsensor_channel: str = 'LIDAR_TOP',
                                   camera_channel: str = 'CAM_FRONT',
        ...
        #  Modifying here.
        # black_im = Image.new('RGB', im.size, (0, 0, 0))
        # black_im = cv2.cvtColor(im, cv2.COLOR_RGB2GRAY)
        im_array = np.array(im.get_array())
        black_im = cv2.cvtColor(im_array, cv2.COLOR_RGB2GRAY)
        # ax.imshow(black_im)
        
        
        # import matplotlib.colors as mcolors
        # custom_color = (0.2, 0.2, 0.2)
        # cmap = mcolors.LinearSegmentedColormap.from_list('my_cmap', [custom_color, 'white'])

        #ax.imshow(im)
        # ax.scatter(points[0, :], points[1, :], c=coloring, s=dot_size, cmap=cmap)
        # ax.axis('off')
        # ax.imshow(black_im)
        ax.imshow(black_im, cmap='gray')
        ax.scatter(points[0, :], points[1, :], c=coloring, s=dot_size)
        ax.axis('off')
    ...
    def render_pointcloud_in_sweep(self, image_path: str, **kwargs):
        ...
        # Call the render_pointcloud_in_image function with the provided image path and other arguments.
        self.render_pointcloud_in_image(sample_token=sample_token, out_path=None, **kwargs)
